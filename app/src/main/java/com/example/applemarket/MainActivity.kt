...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter.itemClick = object : ItemAdapter.ItemClick {
            override fun onClick(view: View, position: Int) {
                ...
                intent.putExtra(com.example.applemarket.Constants.ITEM_INDEX, position);
                intent.putExtra(com.example.applemarket.Constants.ITEM_OBJECT, dataList[position]);
        ...
        adapter.itemLongClick = object : ItemAdapter.ItemLongClick {
            override fun onLongClick(view: View, position: Int) {
                ...
                ad.setIcon(R.drawable.bubblechat)
                ad.setTitle("상품 삭제")
    ...
    fun notification() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            val channelName = "My Chennel One"
